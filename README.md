...
|---|---|---|---|
| **Google Gemini** | [aistudio.google.com/apikey](https://aistudio.google.com/apikey) — 1 минута, без карты | бесплатный tier | `GEMINI_API_KEY`, `GEMINI_MODEL=gemini-flash-lite-latest` |
